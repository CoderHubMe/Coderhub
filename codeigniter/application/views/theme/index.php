...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url('index2.html') ?>" class="logo">
      ...
      <span class="logo-lg">Coder<b>Hub</b>.me</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?= menu_is_active('user', $theme) ? 'active' : '' ?>">
          <a href="#">
        ...
        <li class="treeview <?= menu_is_active('companies', $theme) ? 'active' : '' ?>">
          <a href="#">
            <i class="fa fa-building"></i> <span>Companies</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?= base_url() ?>"><i class="fa fa-circle-o"></i> Search Companies</a></li>
            <li><a href="<?= base_url() ?>"><i class="fa fa-circle-o"></i> My Companies</a></li>
            <li><a href="<?= base_url() ?>"><i class="fa fa-circle-o"></i> Add Company</a></li>
          </ul>
        </li>
      </ul>
    </section>
